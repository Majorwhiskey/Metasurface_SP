...
% Define ANN with 300 hidden neurons
net = feedforwardnet(300); % Feedforward network with one hidden layer
...
predicted_outputs = net(testing_inputs')';
...
writetable(results_table, 'ANN_Results.csv');
disp('Results saved as "ANN_Results.csv".');
